...
namespace APIVerve
{
    public class UserAgentGeneratorAPIClient
    {
        ...
        public UserAgentGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public UserAgentGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
